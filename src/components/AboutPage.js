    ...
    <div className='about-container'>
        ...
        <div className='about-text-container'>
            ...
            <div className='about-text'>
                ...
                <br/><br/><br/>
                Our mission is simple: provide the best product at the best price for our customers. At Honey Bins, you will find amazing products for unbelievable prices.
                <br/><br/><br/>
